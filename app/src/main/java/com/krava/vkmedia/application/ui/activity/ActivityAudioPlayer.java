...
import com.krava.vkmedia.application.ui.Dp;
import com.krava.vkmedia.application.ui.service.AudioPlayerService;
import com.krava.vkmedia.application.ui.widget.CircularSeekBar;
import com.krava.vkmedia.application.ui.widget.PlayerPopupWindow;
...
public class ActivityAudioPlayer extends AppCompatActivity {
                    ...
                    new Handler(Looper.getMainLooper()).post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if(!seekbarInTracking && intent.hasExtra("percent") && intent.hasExtra("position")) {
                                ...
                                String time = "";
                                int duration = intent.getIntExtra("position", 0);
    ...
    protected void onCreate(@Nullable final Bundle savedInstanceState) {
        ...
        playAction.setOnClickListener(new View.OnClickListener() {
            @Override
...
//        getSongCoverAsync.execute(AudioPlayerService.sharedInstance.currentSong.url);
        ...
        invalidateRepeat();
        findViewById(R.id.shufle).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

            }
        });
        findViewById(R.id.next_track).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        findViewById(R.id.prev_track).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        findViewById(R.id.menu_popup).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(popup == null) {
                    popup = new PlayerPopupWindow(ActivityAudioPlayer.this);
